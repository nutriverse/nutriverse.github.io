...
[nutriverse](https://nutriverse.io) develops open source technical tools and systems along with a community of practice infrastructure that actively participates in, leverages, and stewards the use of these tools and systems for the purpose of open and reproducible nutrition data analytics and research. Our core team and community cultivate an inclusive and welcoming space where people with diverse backgrounds and experience levels can learn, exchange ideas, and collaborate openly through shared norms and open-source software. All participation in nutriverse activities is guided by our [Code of Conduct](https://nutriverse.io/code-of-conduct.html).
...
![](../images/explore.svg){style="float: right; margin: 10px; width: 250px"}
...
#### Explore and discover packages I can use to facilitate my research and access open health and nutrition data
...
![](../images/link.svg){style="float: right; margin: 10px; width: 250px"}
...
![](../images/learn.svg){style="float: right; margin: 10px; width: 250px"}

:::

[nutriverse](https://nutriverse.io) offers opportunities for both new and experienced [R](https://r-project.org){.external target="_blank"} users and developers to grow, whether by reading and listening, or by learning through hands-on experience. All of this takes place in a culture grounded in trust, generosity, proper attribution, and appreciation.
...
![](../images/create.svg){style="float: right; margin: 10px; width: 250px"}

:::

People often think of contributing to [nutriverse](https://nutriverse.io) in terms of shaping and advancing the research software ecosystem for health and nutrition in [R](https://r-project.org){.external target="_blank"}. This can include participating in package development and documentation, joining discussions around new initiatives such as helping promote more open and reproducible research practices within your department, institution, or broader field.
...
![](../images/support.svg){style="float: right; margin: 10px; width: 250px"}
